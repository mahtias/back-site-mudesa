...
class orgSocioController extends Controller
{
    protected $model;
    public function __construct(OrgSocio $exemple){
    ...
    public function store(Request $request)
    {
        ...
        $resultat->objet=$request->get("objet");
    ...
    {
        //
        $resultat=OrgSocio::find($request->input("id"));
